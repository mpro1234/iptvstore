...
const productSchema = new mongoose_1.Schema({
    ...
    server: { type: mongoose_1.Schema.Types.ObjectId, ref: "Server", required: true }, // ربط مع نموذج السيرفر
    price: { type: Number, required: true },
    discountedPrice: { type: Number, default: null }, // السعر بعد الخصم (اختياري)
    image: { type: String, required: true },
    comments: [{ type: mongoose_1.Schema.Types.ObjectId, ref: "Comment" }], // ربط مع نموذج التعليقات
